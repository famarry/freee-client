...
class ExpenseApplicationResponseExpenseApplication implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'section_id'             => 'int',
        'tag_ids'                => 'int[]',
        'purchase_lines'         => '\OpenAPI\Client\Model\ExpenseApplicationResponseExpenseApplicationPurchaseLines[]',
        'deal_id'                => 'int',
        'deal_status'            => 'string',
        'applicant_id'           => 'int',
     ...
     * Gets purchase_lines.
     *
     * @return \OpenAPI\Client\Model\ExpenseApplicationResponseExpenseApplicationPurchaseLines[]|null
     */
     ...
     * Sets purchase_lines.
     *
     * @param \OpenAPI\Client\Model\ExpenseApplicationResponseExpenseApplicationPurchaseLines[]|null $purchase_lines 経費申請の申請行一覧（配列）
     *
     * @return self
     */
     ...
     * Sets parent_id.
     *
     * @param int|null $parent_id 親申請ID。各種申請が使用可能なプランの時のみレスポンスに含まれます。
     *
     * @return self
     */
    public function setParentId($parent_id)
    {
        if (!is_null($parent_id) && ($parent_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $parent_id when calling ExpenseApplicationResponseExpenseApplication., must be bigger than or equal to 1.');
        }
