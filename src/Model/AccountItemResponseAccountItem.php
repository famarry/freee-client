...
class AccountItemResponseAccountItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setCode($code)
    {
        if (!is_null($code) && (mb_strlen($code) > 20)) {
            throw new \InvalidArgumentException('invalid length for $code when calling AccountItemResponseAccountItem., must be smaller than or equal to 20.');
        }
    ...
    public function setAccumulatedDepAccountItemId($accumulated_dep_account_item_id)
    {
        if (!is_null($accumulated_dep_account_item_id) && ($accumulated_dep_account_item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $accumulated_dep_account_item_id when calling AccountItemResponseAccountItem., must be bigger than or equal to 1.');
        }
    ...
    public function setGroupId($group_id)
    {
        if (!is_null($group_id) && ($group_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $group_id when calling AccountItemResponseAccountItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCorrespondingIncomeId($corresponding_income_id)
    {
        if (!is_null($corresponding_income_id) && ($corresponding_income_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $corresponding_income_id when calling AccountItemResponseAccountItem., must be bigger than or equal to 1.');
        }
    ...
    public function setCorrespondingExpenseId($corresponding_expense_id)
    {
        if (!is_null($corresponding_expense_id) && ($corresponding_expense_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $corresponding_expense_id when calling AccountItemResponseAccountItem., must be bigger than or equal to 1.');
        }
