...
class CompanyResponseCompanySections implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setIndentCount($indent_count)
    {
        if (!is_null($indent_count) && ($indent_count < 0)) {
            throw new \InvalidArgumentException('invalid value for $indent_count when calling CompanyResponseCompanySections., must be bigger than or equal to 0.');
        }
    ...
    public function setParentId($parent_id)
    {
        if (!is_null($parent_id) && ($parent_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $parent_id when calling CompanyResponseCompanySections., must be bigger than or equal to 1.');
        }
