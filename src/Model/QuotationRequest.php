 ...
 */
class QuotationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'QuotationRequest';
    ...
    protected static $openAPITypes = [
        ...
        'lines'                           => '\OpenAPI\Client\Model\QuotationRequestLines[]',
    ];
    ...
    protected static $setters = [
        ...
        'delivery_deadline'               => 'setDeliveryDeadline',
        ...
        'quotation_note'                  => 'setQuotationNote',
        'memo'                            => 'setMemo',
    ...
    protected static $getters = [
        ...
        'delivery_deadline'               => 'getDeliveryDeadline',
        ...
        'quotation_note'                  => 'getQuotationNote',
        'memo'                            => 'getMemo',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['delivery_deadline']               = $data['delivery_deadline'] ?? null;
        ...
        $this->container['quotation_note']                  = $data['quotation_note'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['quotation_number']) && (mb_strlen($this->container['quotation_number']) > 255)) {
        ...
        if (!is_null($this->container['delivery_deadline']) && (mb_strlen($this->container['delivery_deadline']) > 255)) {
            $invalidProperties[] = "invalid value for 'delivery_deadline', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['delivery_deadline']) && (mb_strlen($this->container['delivery_deadline']) < 1)) {
            $invalidProperties[] = "invalid value for 'delivery_deadline', the character length must be bigger than or equal to 1.";
        }

        if (!is_null($this->container['delivery_location']) && (mb_strlen($this->container['delivery_location']) > 255)) {
            $invalidProperties[] = "invalid value for 'delivery_location', the character length must be smaller than or equal to 255.";
        }

        if (!is_null($this->container['delivery_location']) && (mb_strlen($this->container['delivery_location']) < 1)) {
            $invalidProperties[] = "invalid value for 'delivery_location', the character length must be bigger than or equal to 1.";
        }
        ...
        if (!is_null($this->container['quotation_note']) && (mb_strlen($this->container['quotation_note']) > 4000)) {
            $invalidProperties[] = "invalid value for 'quotation_note', the character length must be smaller than or equal to 4000.";
        }

        if (!is_null($this->container['quotation_note']) && (mb_strlen($this->container['quotation_note']) < 1)) {
            $invalidProperties[] = "invalid value for 'quotation_note', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling QuotationRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTemplateId($template_id)
    {
        ...
        if (!is_null($template_id) && ($template_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling QuotationRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($template_id) && ($template_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling QuotationRequest., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $quotation_number 見積書番号<br> - 採番の設定が、[自動採番する]の場合、指定できません。 - 採番の設定が、[自動採番する]以外の場合、必須になります。
     *
     * @return self
     */
    public function setQuotationNumber($quotation_number)
    {
        if (!is_null($quotation_number) && (mb_strlen($quotation_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $quotation_number when calling QuotationRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setBranchNo($branch_no)
    {
        ...
        if (!is_null($branch_no) && ($branch_no > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $branch_no when calling QuotationRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($branch_no) && ($branch_no < 0)) {
            throw new \InvalidArgumentException('invalid value for $branch_no when calling QuotationRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setQuotationDate($quotation_date)
    {
        ...
        if ((!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $quotation_date))) {
            throw new \InvalidArgumentException("invalid value for $quotation_date when calling QuotationRequest., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setExpirationDate($expiration_date)
    {
        ...
        if (!is_null($expiration_date) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $expiration_date))) {
            throw new \InvalidArgumentException("invalid value for $expiration_date when calling QuotationRequest., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    /**
     * Gets delivery_deadline.
     *
     * @return string|null
     */
    public function getDeliveryDeadline()
    {
        return $this->container['delivery_deadline'];
    }

    /**
     * Sets delivery_deadline.
     *
     * @param string|null $delivery_deadline 納品期限
     *
     * @return self
     */
    public function setDeliveryDeadline($delivery_deadline)
    {
        if (!is_null($delivery_deadline) && (mb_strlen($delivery_deadline) > 255)) {
            throw new \InvalidArgumentException('invalid length for $delivery_deadline when calling QuotationRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($delivery_deadline) && (mb_strlen($delivery_deadline) < 1)) {
            throw new \InvalidArgumentException('invalid length for $delivery_deadline when calling QuotationRequest., must be bigger than or equal to 1.');
        }

        $this->container['delivery_deadline'] = $delivery_deadline;
     ...
     *
     * @param string|null $delivery_location 納品場所
     *
     * @return self
     */
    public function setDeliveryLocation($delivery_location)
    {
        if (!is_null($delivery_location) && (mb_strlen($delivery_location) > 255)) {
            throw new \InvalidArgumentException('invalid length for $delivery_location when calling QuotationRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($delivery_location) && (mb_strlen($delivery_location) < 1)) {
            throw new \InvalidArgumentException('invalid length for $delivery_location when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setSubject($subject)
    {
        if (!is_null($subject) && (mb_strlen($subject) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling QuotationRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($subject) && (mb_strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    {
        return $this->container['quotation_note'];
    }

    /**
     * Sets quotation_note.
     *
     * @param string|null $quotation_note 備考
     *
     * @return self
     */
    public function setQuotationNote($quotation_note)
    {
        if (!is_null($quotation_note) && (mb_strlen($quotation_note) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $quotation_note when calling QuotationRequest., must be smaller than or equal to 4000.');
        }
        if (!is_null($quotation_note) && (mb_strlen($quotation_note) < 1)) {
            throw new \InvalidArgumentException('invalid length for $quotation_note when calling QuotationRequest., must be bigger than or equal to 1.');
        }

        $this->container['quotation_note'] = $quotation_note;
    ...
    public function setMemo($memo)
    {
        if (!is_null($memo) && (mb_strlen($memo) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling QuotationRequest., must be smaller than or equal to 2000.');
        }
        if (!is_null($memo) && (mb_strlen($memo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (!is_null($partner_id) && ($partner_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling QuotationRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($partner_id) && ($partner_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerAddressZipcode($partner_address_zipcode)
    {
        if (!is_null($partner_address_zipcode) && (mb_strlen($partner_address_zipcode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_zipcode when calling QuotationRequest., must be smaller than or equal to 10.');
        }
        if (!is_null($partner_address_zipcode) && (mb_strlen($partner_address_zipcode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_zipcode when calling QuotationRequest., must be bigger than or equal to 1.');
        }
        if (!is_null($partner_address_zipcode) && (!preg_match('/^[0-9]{3}[\\-]?[0-9]{4}$/', $partner_address_zipcode))) {
            throw new \InvalidArgumentException("invalid value for $partner_address_zipcode when calling QuotationRequest., must conform to the pattern /^[0-9]{3}[\\-]?[0-9]{4}$/.");
        }
    ...
    public function setPartnerAddressPrefectureCode($partner_address_prefecture_code)
    {
        ...
        if (!is_null($partner_address_prefecture_code) && ($partner_address_prefecture_code > 46)) {
            throw new \InvalidArgumentException('invalid value for $partner_address_prefecture_code when calling QuotationRequest., must be smaller than or equal to 46.');
        }
        if (!is_null($partner_address_prefecture_code) && ($partner_address_prefecture_code < -1)) {
            throw new \InvalidArgumentException('invalid value for $partner_address_prefecture_code when calling QuotationRequest., must be bigger than or equal to -1.');
        }
    ...
    public function setPartnerAddressStreetName1($partner_address_street_name1)
    {
        if (!is_null($partner_address_street_name1) && (mb_strlen($partner_address_street_name1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name1 when calling QuotationRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_address_street_name1) && (mb_strlen($partner_address_street_name1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name1 when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerAddressStreetName2($partner_address_street_name2)
    {
        if (!is_null($partner_address_street_name2) && (mb_strlen($partner_address_street_name2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name2 when calling QuotationRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_address_street_name2) && (mb_strlen($partner_address_street_name2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name2 when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerContactDepartment($partner_contact_department)
    {
        if (!is_null($partner_contact_department) && (mb_strlen($partner_contact_department) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_department when calling QuotationRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_contact_department) && (mb_strlen($partner_contact_department) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_department when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerContactEmailCc($partner_contact_email_cc)
    {
        if (!is_null($partner_contact_email_cc) && (mb_strlen($partner_contact_email_cc) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_cc when calling QuotationRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_contact_email_cc) && (mb_strlen($partner_contact_email_cc) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_cc when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerContactEmailTo($partner_contact_email_to)
    {
        if (!is_null($partner_contact_email_to) && (mb_strlen($partner_contact_email_to) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_to when calling QuotationRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_contact_email_to) && (mb_strlen($partner_contact_email_to) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_to when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerContactName($partner_contact_name)
    {
        if (!is_null($partner_contact_name) && (mb_strlen($partner_contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_name when calling QuotationRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_contact_name) && (mb_strlen($partner_contact_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_name when calling QuotationRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerDisplayName($partner_display_name)
    {
        if (!is_null($partner_display_name) && (mb_strlen($partner_display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_display_name when calling QuotationRequest., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string|null $company_contact_name 自社担当者(デフォルトは操作者の表示ユーザー名が補完されます)
     *
     * @return self
     */
    public function setCompanyContactName($company_contact_name)
    {
        if (!is_null($company_contact_name) && (mb_strlen($company_contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_contact_name when calling QuotationRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyName($company_name)
    {
        if (!is_null($company_name) && (mb_strlen($company_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling QuotationRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyDescription($company_description)
    {
        if (!is_null($company_description) && (mb_strlen($company_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_description when calling QuotationRequest., must be smaller than or equal to 255.');
        }
     ...
     * Gets lines.
     *
     * @return \OpenAPI\Client\Model\QuotationRequestLines[]
     */
     ...
     * Sets lines.
     *
     * @param \OpenAPI\Client\Model\QuotationRequestLines[] $lines 請求書の明細行
     *
     * @return self
     */
