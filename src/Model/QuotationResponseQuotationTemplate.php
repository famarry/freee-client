...
/**
 * QuotationResponseQuotationTemplate Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class QuotationResponseQuotationTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'QuotationResponse_quotation_template';
     ...
     * Sets title.
     *
     * @param string|null $title 見積書タイトル
     *
     * @return self
     */
