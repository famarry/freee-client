...
/**
 * WalletableUpdateResponse Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class WalletableUpdateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'walletableUpdateResponse';
    ...
    {
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling WalletableUpdateResponse., must be bigger than or equal to 1.');
        }
    ...
    public function setName($name)
    {
        if ((mb_strlen($name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $name when calling WalletableUpdateResponse., must be smaller than or equal to 255.');
        }
    ...
    {
        if (($bank_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $bank_id when calling WalletableUpdateResponse., must be bigger than or equal to 1.');
        }
