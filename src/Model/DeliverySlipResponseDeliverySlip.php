...
/**
 * DeliverySlipResponseDeliverySlip Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class DeliverySlipResponseDeliverySlip implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeliverySlipResponse_delivery_slip';
    ...
    protected static $openAPITypes = [
        ...
        'lines'                           => '\OpenAPI\Client\Model\DeliverySlipResponseDeliverySlipLines[]',
    ];
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DeliverySlipResponseDeliverySlip., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 9223372036854775807.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling DeliverySlipResponseDeliverySlip., must be bigger than or equal to 1.');
        }
    ...
    public function setDeliverySlipNumber($delivery_slip_number)
    {
        if ((mb_strlen($delivery_slip_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $delivery_slip_number when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setBranchNo($branch_no)
    {
        ...
        if (!is_null($branch_no) && ($branch_no > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $branch_no when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($branch_no) && ($branch_no < 0)) {
            throw new \InvalidArgumentException('invalid value for $branch_no when calling DeliverySlipResponseDeliverySlip., must be bigger than or equal to 0.');
        }
    ...
    public function setSubject($subject)
    {
        if ((mb_strlen($subject) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setTemplateId($template_id)
    {
        ...
        if (!is_null($template_id) && ($template_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($template_id) && ($template_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling DeliverySlipResponseDeliverySlip., must be bigger than or equal to 1.');
        }
    ...
    public function setTemplateName($template_name)
    {
        if (!is_null($template_name) && (mb_strlen($template_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $template_name when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setDeliverySlipDate($delivery_slip_date)
    {
        ...
        if ((!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $delivery_slip_date))) {
            throw new \InvalidArgumentException("invalid value for $delivery_slip_date when calling DeliverySlipResponseDeliverySlip., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setIssueDate($issue_date)
    {
        ...
        if (!is_null($issue_date) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $issue_date))) {
            throw new \InvalidArgumentException("invalid value for $issue_date when calling DeliverySlipResponseDeliverySlip., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setPaymentDate($payment_date)
    {
        ...
        if (!is_null($payment_date) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $payment_date))) {
            throw new \InvalidArgumentException("invalid value for $payment_date when calling DeliverySlipResponseDeliverySlip., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setDeliverySlipNote($delivery_slip_note)
    {
        if ((mb_strlen($delivery_slip_note) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $delivery_slip_note when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 4000.');
        }
    ...
    public function setMemo($memo)
    {
        if ((mb_strlen($memo) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 2000.');
        }
    ...
    public function setDealId($deal_id)
    {
        ...
        if (!is_null($deal_id) && ($deal_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $deal_id when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($deal_id) && ($deal_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $deal_id when calling DeliverySlipResponseDeliverySlip., must be bigger than or equal to 1.');
        }
    ...
    public function setCreatedAt($created_at)
    {
        ...
        if ((!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}(:[0-9]{2})?$/', $created_at))) {
            throw new \InvalidArgumentException("invalid value for $created_at when calling DeliverySlipResponseDeliverySlip., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}(:[0-9]{2})?$/.");
        }
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (($partner_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 9223372036854775807.');
        }
        if (($partner_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling DeliverySlipResponseDeliverySlip., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerName($partner_name)
    {
        if (!is_null($partner_name) && (mb_strlen($partner_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_name when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerAddressZipcode($partner_address_zipcode)
    {
        if (!is_null($partner_address_zipcode) && (mb_strlen($partner_address_zipcode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_zipcode when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 10.');
        }
    ...
    public function setPartnerAddressPrefectureCode($partner_address_prefecture_code)
    {
        ...
        if (!is_null($partner_address_prefecture_code) && ($partner_address_prefecture_code > 46)) {
            throw new \InvalidArgumentException('invalid value for $partner_address_prefecture_code when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 46.');
        }
        if (!is_null($partner_address_prefecture_code) && ($partner_address_prefecture_code < -1)) {
            throw new \InvalidArgumentException('invalid value for $partner_address_prefecture_code when calling DeliverySlipResponseDeliverySlip., must be bigger than or equal to -1.');
        }
    ...
    public function setPartnerAddressStreetName1($partner_address_street_name1)
    {
        if (!is_null($partner_address_street_name1) && (mb_strlen($partner_address_street_name1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name1 when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerAddressStreetName2($partner_address_street_name2)
    {
        if (!is_null($partner_address_street_name2) && (mb_strlen($partner_address_street_name2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name2 when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerContactDepartment($partner_contact_department)
    {
        if (!is_null($partner_contact_department) && (mb_strlen($partner_contact_department) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_department when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerContactEmailCc($partner_contact_email_cc)
    {
        if (!is_null($partner_contact_email_cc) && (mb_strlen($partner_contact_email_cc) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_cc when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerContactEmailTo($partner_contact_email_to)
    {
        if (!is_null($partner_contact_email_to) && (mb_strlen($partner_contact_email_to) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_to when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerContactName($partner_contact_name)
    {
        if (!is_null($partner_contact_name) && (mb_strlen($partner_contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_name when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerDisplayName($partner_display_name)
    {
        if (!is_null($partner_display_name) && (mb_strlen($partner_display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_display_name when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerBankAccount($partner_bank_account)
    {
        if (!is_null($partner_bank_account) && (mb_strlen($partner_bank_account) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_bank_account when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyContactName($company_contact_name)
    {
        if (!is_null($company_contact_name) && (mb_strlen($company_contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_contact_name when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyName($company_name)
    {
        if (!is_null($company_name) && (mb_strlen($company_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling DeliverySlipResponseDeliverySlip., must be smaller than or equal to 255.');
        }
     ...
     * Gets lines.
     *
     * @return \OpenAPI\Client\Model\DeliverySlipResponseDeliverySlipLines[]
     */
     ...
     * Sets lines.
     *
     * @param \OpenAPI\Client\Model\DeliverySlipResponseDeliverySlipLines[] $lines 納品書の明細行
     *
     * @return self
     */
