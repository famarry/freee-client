...
class ConflictError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'status_code' => 'int',
        'errors'      => '\OpenAPI\Client\Model\ConflictErrorErrors[]',
    ];
     ...
     * Gets errors.
     *
     * @return \OpenAPI\Client\Model\ConflictErrorErrors[]|null
     */
     ...
     * Sets errors.
     *
     * @param \OpenAPI\Client\Model\ConflictErrorErrors[]|null $errors errors
     *
     * @return self
     */
