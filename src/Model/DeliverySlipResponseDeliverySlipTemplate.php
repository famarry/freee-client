...
/**
 * DeliverySlipResponseDeliverySlipTemplate Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class DeliverySlipResponseDeliverySlipTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeliverySlipResponse_delivery_slip_template';
     ...
     * Sets title.
     *
     * @param string|null $title 納品書タイトル
     *
     * @return self
     */
