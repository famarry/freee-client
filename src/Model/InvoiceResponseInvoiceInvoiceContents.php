...
/**
 * InvoiceResponseInvoiceInvoiceContents Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceResponseInvoiceInvoiceContents implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'invoiceResponse_invoice_invoice_contents';
    ...
    {
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InvoiceResponseInvoiceInvoiceContents., must be bigger than or equal to 1.');
        }
    ...
    {
        if (($order > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $order when calling InvoiceResponseInvoiceInvoiceContents., must be smaller than or equal to 2147483647.');
        }
        if (($order < 0)) {
            throw new \InvalidArgumentException('invalid value for $order when calling InvoiceResponseInvoiceInvoiceContents., must be bigger than or equal to 0.');
        }
    ...
    public function setAmount($amount)
    {
        if (($amount > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling InvoiceResponseInvoiceInvoiceContents., must be smaller than or equal to 9223372036854775807.');
        }
        if (($amount < -9223372036854775808)) {
            throw new \InvalidArgumentException('invalid value for $amount when calling InvoiceResponseInvoiceInvoiceContents., must be bigger than or equal to -9223372036854775808.');
        }
    ...
    public function setAccountItemId($account_item_id)
    {
        if (($account_item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling InvoiceResponseInvoiceInvoiceContents., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxCode($tax_code)
    {
        if (($tax_code > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $tax_code when calling InvoiceResponseInvoiceInvoiceContents., must be smaller than or equal to 2147483647.');
        }
        if (($tax_code < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_code when calling InvoiceResponseInvoiceInvoiceContents., must be bigger than or equal to 0.');
        }
    ...
    {
        if (($item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling InvoiceResponseInvoiceInvoiceContents., must be bigger than or equal to 1.');
        }
    ...
    {
        if (($section_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling InvoiceResponseInvoiceInvoiceContents., must be bigger than or equal to 1.');
        }
    ...
    public function setSegment1TagId($segment_1_tag_id)
    {
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling InvoiceResponseInvoiceInvoiceContents., must be bigger than or equal to 1.');
        }
    ...
    public function setSegment2TagId($segment_2_tag_id)
    {
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling InvoiceResponseInvoiceInvoiceContents., must be bigger than or equal to 1.');
        }
    ...
    public function setSegment3TagId($segment_3_tag_id)
    {
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling InvoiceResponseInvoiceInvoiceContents., must be bigger than or equal to 1.');
        }
