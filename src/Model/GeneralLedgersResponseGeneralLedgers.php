...
/**
 * GeneralLedgersResponseGeneralLedgers Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class GeneralLedgersResponseGeneralLedgers implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'generalLedgersResponse_general_ledgers';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['final_balance']     = $data['final_balance'] ?? null;
     ...
     *
     * @param string|null $account_item_name 勘定科目名
     *
     * @return self
     */
     ...
     * Sets total_amount.
     *
     * @param int|null $total_amount 発生額累計
     *
     * @return self
     */
    ...
    {
        return $this->container['final_balance'];
    }

    /**
     * Sets final_balance.
     *
     * @param int|null $final_balance 残高
     *
     * @return self
     */
    public function setFinalBalance($final_balance)
    {
        $this->container['final_balance'] = $final_balance;
     ...
     * Sets debit_amount.
     *
     * @param int|null $debit_amount 借方発生額累計
     *
     * @return self
     */
     ...
     * Sets credit_amount.
     *
     * @param int|null $credit_amount 貸方発生額累計
     *
     * @return self
     */
