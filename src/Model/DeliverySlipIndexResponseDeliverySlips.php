...
/**
 * DeliverySlipIndexResponseDeliverySlips Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class DeliverySlipIndexResponseDeliverySlips implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'DeliverySlipIndexResponse_delivery_slips';
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling DeliverySlipIndexResponseDeliverySlips., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 9223372036854775807.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling DeliverySlipIndexResponseDeliverySlips., must be bigger than or equal to 1.');
        }
    ...
    public function setDeliverySlipNumber($delivery_slip_number)
    {
        if ((mb_strlen($delivery_slip_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $delivery_slip_number when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 255.');
        }
    ...
    public function setSubject($subject)
    {
        if ((mb_strlen($subject) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 255.');
        }
    ...
    public function setTemplateId($template_id)
    {
        ...
        if (!is_null($template_id) && ($template_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($template_id) && ($template_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling DeliverySlipIndexResponseDeliverySlips., must be bigger than or equal to 1.');
        }
    ...
    public function setDeliverySlipDate($delivery_slip_date)
    {
        ...
        if ((!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $delivery_slip_date))) {
            throw new \InvalidArgumentException("invalid value for $delivery_slip_date when calling DeliverySlipIndexResponseDeliverySlips., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setIssueDate($issue_date)
    {
        ...
        if (!is_null($issue_date) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $issue_date))) {
            throw new \InvalidArgumentException("invalid value for $issue_date when calling DeliverySlipIndexResponseDeliverySlips., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setMemo($memo)
    {
        if ((mb_strlen($memo) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 2000.');
        }
    ...
    public function setDealId($deal_id)
    {
        ...
        if (!is_null($deal_id) && ($deal_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $deal_id when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($deal_id) && ($deal_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $deal_id when calling DeliverySlipIndexResponseDeliverySlips., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (($partner_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 9223372036854775807.');
        }
        if (($partner_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling DeliverySlipIndexResponseDeliverySlips., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerName($partner_name)
    {
        if (!is_null($partner_name) && (mb_strlen($partner_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_name when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerDisplayName($partner_display_name)
    {
        if (!is_null($partner_display_name) && (mb_strlen($partner_display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_display_name when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyContactName($company_contact_name)
    {
        if (!is_null($company_contact_name) && (mb_strlen($company_contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_contact_name when calling DeliverySlipIndexResponseDeliverySlips., must be smaller than or equal to 255.');
        }
    ...
    public function setEmailUrlFileDownloadedAt($email_url_file_downloaded_at)
    {
        ...
        if (!is_null($email_url_file_downloaded_at) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}(:[0-9]{2})?$/', $email_url_file_downloaded_at))) {
            throw new \InvalidArgumentException("invalid value for $email_url_file_downloaded_at when calling DeliverySlipIndexResponseDeliverySlips., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}(:[0-9]{2})?$/.");
        }
