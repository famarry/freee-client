...
class TrialBsThreeYearsResponseTrialBsThreeYears implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function setSectionId($section_id)
    {
        if (!is_null($section_id) && ($section_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling TrialBsThreeYearsResponseTrialBsThreeYears., must be bigger than or equal to 1.');
        }
