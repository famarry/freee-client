...
/**
 * ExpenseApplicationsIndexResponsePurchaseLines.
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * ExpenseApplicationsIndexResponsePurchaseLines Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class ExpenseApplicationsIndexResponsePurchaseLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'expenseApplicationsIndexResponse_purchase_lines';
    ...
    protected static $attributeMap = [
        ...
        'sub_receipt_ids'           => 'sub_receipt_ids',
    ...
    protected static $setters = [
        ...
        'sub_receipt_ids'           => 'setSubReceiptIds',
    ...
    protected static $getters = [
        ...
        'sub_receipt_ids'           => 'getSubReceiptIds',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sub_receipt_ids']           = $data['sub_receipt_ids'] ?? null;
    ...
    {
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling ExpenseApplicationsIndexResponsePurchaseLines., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param string|null $transaction_date 発生日 (yyyy-mm-dd)
     *
     * @return self
     */
    ...
    public function setReceiptId($receipt_id)
    {
        if (!is_null($receipt_id) && ($receipt_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $receipt_id when calling ExpenseApplicationsIndexResponsePurchaseLines., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets sub_receipt_ids.
     *
     * @return int[]|null
     */
    public function getSubReceiptIds()
    {
        return $this->container['sub_receipt_ids'];
    }

    /**
     * Sets sub_receipt_ids.
     *
     * @param int[]|null $sub_receipt_ids 補足資料（配列）   receipt_id（証憑ファイル）を指定してください。
     *
     * @return self
     */
    public function setSubReceiptIds($sub_receipt_ids)
    {
        $this->container['sub_receipt_ids'] = $sub_receipt_ids;
     ...
     *
     * @return \OpenAPI\Client\Model\ExpenseApplicationsIndexResponseExpenseApplicationLines[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ExpenseApplicationsIndexResponseExpenseApplicationLines[]|null $expense_application_lines 明細行一覧（配列）
     *
     * @return self
     */
