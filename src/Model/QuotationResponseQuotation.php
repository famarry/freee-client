...
class QuotationResponseQuotation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'lines'                           => '\OpenAPI\Client\Model\QuotationResponseQuotationLines[]',
    ];
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling QuotationResponseQuotation., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling QuotationResponseQuotation., must be smaller than or equal to 9223372036854775807.');
        }
        if (($company_id < 1)) {
    ...
    public function setQuotationNumber($quotation_number)
    {
        if ((mb_strlen($quotation_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $quotation_number when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setBranchNo($branch_no)
    {
        ...
        if (!is_null($branch_no) && ($branch_no > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $branch_no when calling QuotationResponseQuotation., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($branch_no) && ($branch_no < 0)) {
            throw new \InvalidArgumentException('invalid value for $branch_no when calling QuotationResponseQuotation., must be bigger than or equal to 0.');
        }
    ...
    public function setSubject($subject)
    {
        if ((mb_strlen($subject) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setTemplateId($template_id)
    {
        ...
        if (!is_null($template_id) && ($template_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling QuotationResponseQuotation., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($template_id) && ($template_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling QuotationResponseQuotation., must be bigger than or equal to 1.');
        }
    ...
    public function setTemplateName($template_name)
    {
        if (!is_null($template_name) && (mb_strlen($template_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $template_name when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setQuotationDate($quotation_date)
    {
        ...
        if ((!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $quotation_date))) {
            throw new \InvalidArgumentException("invalid value for $quotation_date when calling QuotationResponseQuotation., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setExpirationDate($expiration_date)
    {
        ...
        if (!is_null($expiration_date) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $expiration_date))) {
            throw new \InvalidArgumentException("invalid value for $expiration_date when calling QuotationResponseQuotation., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setDeliveryDeadline($delivery_deadline)
    {
        if ((mb_strlen($delivery_deadline) > 255)) {
            throw new \InvalidArgumentException('invalid length for $delivery_deadline when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setDeliveryLocation($delivery_location)
    {
        if ((mb_strlen($delivery_location) > 255)) {
            throw new \InvalidArgumentException('invalid length for $delivery_location when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setQuotationNote($quotation_note)
    {
        if ((mb_strlen($quotation_note) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $quotation_note when calling QuotationResponseQuotation., must be smaller than or equal to 4000.');
        }
    ...
    public function setMemo($memo)
    {
        if ((mb_strlen($memo) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling QuotationResponseQuotation., must be smaller than or equal to 2000.');
        }
    ...
    public function setCreatedAt($created_at)
    {
        ...
        if ((!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}(:[0-9]{2})?$/', $created_at))) {
            throw new \InvalidArgumentException("invalid value for $created_at when calling QuotationResponseQuotation., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2} [0-9]{2}:[0-9]{2}(:[0-9]{2})?$/.");
        }
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (($partner_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling QuotationResponseQuotation., must be smaller than or equal to 9223372036854775807.');
        }
        if (($partner_id < 1)) {
    ...
    public function setPartnerName($partner_name)
    {
        if (!is_null($partner_name) && (mb_strlen($partner_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_name when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerAddressZipcode($partner_address_zipcode)
    {
        if (!is_null($partner_address_zipcode) && (mb_strlen($partner_address_zipcode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_zipcode when calling QuotationResponseQuotation., must be smaller than or equal to 10.');
        }
    ...
    public function setPartnerAddressPrefectureCode($partner_address_prefecture_code)
    {
        ...
        if (!is_null($partner_address_prefecture_code) && ($partner_address_prefecture_code > 46)) {
            throw new \InvalidArgumentException('invalid value for $partner_address_prefecture_code when calling QuotationResponseQuotation., must be smaller than or equal to 46.');
        }
        if (!is_null($partner_address_prefecture_code) && ($partner_address_prefecture_code < -1)) {
            throw new \InvalidArgumentException('invalid value for $partner_address_prefecture_code when calling QuotationResponseQuotation., must be bigger than or equal to -1.');
        }
    ...
    public function setPartnerAddressStreetName1($partner_address_street_name1)
    {
        if (!is_null($partner_address_street_name1) && (mb_strlen($partner_address_street_name1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name1 when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerAddressStreetName2($partner_address_street_name2)
    {
        if (!is_null($partner_address_street_name2) && (mb_strlen($partner_address_street_name2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name2 when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerContactDepartment($partner_contact_department)
    {
        if (!is_null($partner_contact_department) && (mb_strlen($partner_contact_department) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_department when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerContactEmailCc($partner_contact_email_cc)
    {
        if (!is_null($partner_contact_email_cc) && (mb_strlen($partner_contact_email_cc) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_cc when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerContactEmailTo($partner_contact_email_to)
    {
        if (!is_null($partner_contact_email_to) && (mb_strlen($partner_contact_email_to) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_to when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerContactName($partner_contact_name)
    {
        if (!is_null($partner_contact_name) && (mb_strlen($partner_contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_name when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setPartnerDisplayName($partner_display_name)
    {
        if (!is_null($partner_display_name) && (mb_strlen($partner_display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_display_name when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyContactName($company_contact_name)
    {
        if (!is_null($company_contact_name) && (mb_strlen($company_contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_contact_name when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyName($company_name)
    {
        if (!is_null($company_name) && (mb_strlen($company_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyDescription($company_description)
    {
        if (!is_null($company_description) && (mb_strlen($company_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_description when calling QuotationResponseQuotation., must be smaller than or equal to 255.');
        }
     ...
     * Gets lines.
     *
     * @return \OpenAPI\Client\Model\QuotationResponseQuotationLines[]
     */
     ...
     * Sets lines.
     *
     * @param \OpenAPI\Client\Model\QuotationResponseQuotationLines[] $lines 請求書の明細行
     *
     * @return self
     */
