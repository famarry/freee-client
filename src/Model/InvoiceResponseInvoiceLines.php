...
/**
 * InvoiceResponseInvoiceLines Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceResponseInvoiceLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InvoiceResponse_invoice_lines';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['reduced_tax_rate']     = $data['reduced_tax_rate'] ?? null;
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InvoiceResponseInvoiceLines., must be bigger than or equal to 1.');
        }
     ...
     * Sets type.
     *
     * @param string $type 明細の種類 - item: 品目行 - text: テキスト行 - textの時はsales_date、quantity、unit_price、tax_rate、amount_excluding_tax、account_item_id、tax_code、item_id、section_id、segment_1_tag_id、segment_2_tag_id、segment_3_tag_idはnullになります。
     *
     * @return self
     */
     ...
     * Sets description.
     *
     * @param string $description 摘要（品名）
     *
     * @return self
     */
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 255.');
        }
    ...
    public function setSalesDate($sales_date)
    {
        ...
        if (!is_null($sales_date) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $sales_date))) {
            throw new \InvalidArgumentException("invalid value for $sales_date when calling InvoiceResponseInvoiceLines., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setUnit($unit)
    {
        if (!is_null($unit) && (mb_strlen($unit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 255.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity > 99999999.999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 99999999.999.');
        }
        if (!is_null($quantity) && ($quantity < -99999999.999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling InvoiceResponseInvoiceLines., must be bigger than or equal to -99999999.999.');
        }
     ...
     *
     * @param bool|null $reduced_tax_rate 軽減税率対象（true: 対象、 false: 対象外）
     *
     * @return self
     */
     ...
     *
     * @param float|null $amount_excluding_tax 税別金額
     *
     * @return self
     */
    ...
    public function setAccountItemId($account_item_id)
    {
        ...
        if (!is_null($account_item_id) && ($account_item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($account_item_id) && ($account_item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling InvoiceResponseInvoiceLines., must be bigger than or equal to 1.');
        }
    ...
    public function setTaxCode($tax_code)
    {
        ...
        if (!is_null($tax_code) && ($tax_code > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $tax_code when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($tax_code) && ($tax_code < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_code when calling InvoiceResponseInvoiceLines., must be bigger than or equal to 0.');
        }
    ...
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($item_id) && ($item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling InvoiceResponseInvoiceLines., must be bigger than or equal to 1.');
        }
    ...
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($section_id) && ($section_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling InvoiceResponseInvoiceLines., must be bigger than or equal to 1.');
        }
    ...
    public function setSegment1TagId($segment_1_tag_id)
    {
        ...
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling InvoiceResponseInvoiceLines., must be bigger than or equal to 1.');
        }
    ...
    public function setSegment2TagId($segment_2_tag_id)
    {
        ...
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling InvoiceResponseInvoiceLines., must be bigger than or equal to 1.');
        }
    ...
    public function setSegment3TagId($segment_3_tag_id)
    {
        ...
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling InvoiceResponseInvoiceLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling InvoiceResponseInvoiceLines., must be bigger than or equal to 1.');
        }
