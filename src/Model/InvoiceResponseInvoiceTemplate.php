...
/**
 * InvoiceResponseInvoiceTemplate Class Doc Comment.
 *
 * @category Class
 *
 ...
 */
class InvoiceResponseInvoiceTemplate implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InvoiceResponse_invoice_template';
     ...
     * Sets title.
     *
     * @param string|null $title 請求書タイトル
     *
     * @return self
     */
