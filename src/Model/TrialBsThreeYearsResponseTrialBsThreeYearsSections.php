...
class TrialBsThreeYearsResponseTrialBsThreeYearsSections implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        'id'                               => 'int64',
        'name'                             => null,
        'two_years_before_closing_balance' => 'int64',
        'last_year_closing_balance'        => 'int64',
        'closing_balance'                  => 'int64',
        'year_on_year'                     => null,
    ];
    ...
    {
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling TrialBsThreeYearsResponseTrialBsThreeYearsSections., must be bigger than or equal to 1.');
        }
