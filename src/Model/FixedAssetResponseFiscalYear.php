...
/**
 * FixedAssetResponseFiscalYear Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class FixedAssetResponseFiscalYear implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'fixedAssetResponse_fiscal_year';
     ...
     * Sets start_date.
     *
     * @param string $start_date 会計年度開始日 (yyyy-mm-dd)
     *
     * @return self
     */
     ...
     * Sets end_date.
     *
     * @param string $end_date 会計年度終了日 (yyyy-mm-dd)
     *
     * @return self
     */
