...
/**
 * InvoiceRequestLines Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceRequestLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InvoiceRequest_lines';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['sales_date']       = $data['sales_date'] ?? null;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['sales_date']) && !preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $this->container['sales_date'])) {
            $invalidProperties[] = "invalid value for 'sales_date', must be conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.";
        }
    ...
    public function setDescription($description)
    {
        if (!is_null($description) && (mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InvoiceRequestLines., must be smaller than or equal to 255.');
        }
        if (!is_null($description) && (mb_strlen($description) < 1)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InvoiceRequestLines., must be bigger than or equal to 1.');
        }
     ...
     * Sets sales_date.
     *
     * @param \DateTime|null $sales_date 取引日
     *
     * @return self
     */
    public function setSalesDate($sales_date)
    {
        ...
        if (!is_null($sales_date) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $sales_date))) {
            throw new \InvalidArgumentException("invalid value for $sales_date when calling InvoiceRequestLines., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setUnit($unit)
    {
        if (!is_null($unit) && (mb_strlen($unit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling InvoiceRequestLines., must be smaller than or equal to 255.');
        }
        if (!is_null($unit) && (mb_strlen($unit) < 1)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling InvoiceRequestLines., must be bigger than or equal to 1.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity > 99999999.999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling InvoiceRequestLines., must be smaller than or equal to 99999999.999.');
        }
        if (!is_null($quantity) && ($quantity < -99999999.999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling InvoiceRequestLines., must be bigger than or equal to -99999999.999.');
        }
    ...
    public function setUnitPrice($unit_price)
    {
        ...
        if (!is_null($unit_price) && (!preg_match('/^\\-?[0-9]{0,13}(\\.[0-9]{1,3})?$/', $unit_price))) {
            throw new \InvalidArgumentException("invalid value for $unit_price when calling InvoiceRequestLines., must conform to the pattern /^\\-?[0-9]{0,13}(\\.[0-9]{1,3})?$/.");
        }
     ...
     * Sets tax_rate.
     *
     * @param int|null $tax_rate 税率（%）（帳票の税額計算に用います。）
     *
     * @return self
     */
     ...
     *
     * @param int|null $account_item_id 勘定科目ID（取引登録の下書き保存で利用されます。）
     *
     * @return self
     */
    public function setAccountItemId($account_item_id)
    {
        ...
        if (!is_null($account_item_id) && ($account_item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling InvoiceRequestLines., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($account_item_id) && ($account_item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $account_item_id when calling InvoiceRequestLines., must be bigger than or equal to 1.');
        }
     ...
     * Sets tax_code.
     *
     * @param int|null $tax_code 税区分コード（取引登録の下書き保存で利用されます。）
     *
     * @return self
     */
    public function setTaxCode($tax_code)
    {
        ...
        if (!is_null($tax_code) && ($tax_code > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $tax_code when calling InvoiceRequestLines., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($tax_code) && ($tax_code < 0)) {
            throw new \InvalidArgumentException('invalid value for $tax_code when calling InvoiceRequestLines., must be bigger than or equal to 0.');
        }
     ...
     * Sets item_id.
     *
     * @param int|null $item_id 品目ID（取引登録の下書き保存で利用されます。）
     *
     * @return self
     */
    public function setItemId($item_id)
    {
        ...
        if (!is_null($item_id) && ($item_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling InvoiceRequestLines., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($item_id) && ($item_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $item_id when calling InvoiceRequestLines., must be bigger than or equal to 1.');
        }
     ...
     * Sets section_id.
     *
     * @param int|null $section_id 部門ID<br> - 取引登録の下書き保存で利用されます。 - 親部門は利用できません。 - グループ管理で制限された部門は利用できません。 <br> <a href=\"https://support.freee.co.jp/hc/ja/articles/215225263\" target=\"_blank\">グループ管理の設定はヘルプページを御覧ください。</a>
     *
     * @return self
     */
    public function setSectionId($section_id)
    {
        ...
        if (!is_null($section_id) && ($section_id > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling InvoiceRequestLines., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($section_id) && ($section_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $section_id when calling InvoiceRequestLines., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int|null $segment_1_tag_id セグメント１ID<br> - 取引登録の下書き保存で利用されます。 - freee会計法人向け プロフェッショナルプラン以上で利用可能です。 <br> <a href=\"https://support.freee.co.jp/hc/ja/articles/360020679611\" target=\"_blank\">セグメント（分析用タグ）の設定はヘルプページを御覧ください。</a>
     *
     * @return self
     */
    public function setSegment1TagId($segment_1_tag_id)
    {
        ...
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling InvoiceRequestLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($segment_1_tag_id) && ($segment_1_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_1_tag_id when calling InvoiceRequestLines., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int|null $segment_2_tag_id セグメント２ID<br> - 取引登録の下書き保存で利用されます。 - freee会計法人向け エンタープライズプランで利用可能です。 <br> <a href=\"https://support.freee.co.jp/hc/ja/articles/360020679611\" target=\"_blank\">セグメント（分析用タグ）の設定はヘルプページを御覧ください。</a>
     *
     * @return self
     */
    public function setSegment2TagId($segment_2_tag_id)
    {
        ...
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling InvoiceRequestLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($segment_2_tag_id) && ($segment_2_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_2_tag_id when calling InvoiceRequestLines., must be bigger than or equal to 1.');
        }
     ...
     *
     * @param int|null $segment_3_tag_id セグメント３ID<br> - 取引登録の下書き保存で利用されます。 - freee会計法人向け エンタープライズプランで利用可能です。 <br> <a href=\"https://support.freee.co.jp/hc/ja/articles/360020679611\" target=\"_blank\">セグメント（分析用タグ）の設定はヘルプページを御覧ください。</a>
     *
     * @return self
     */
    public function setSegment3TagId($segment_3_tag_id)
    {
        ...
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling InvoiceRequestLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($segment_3_tag_id) && ($segment_3_tag_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $segment_3_tag_id when calling InvoiceRequestLines., must be bigger than or equal to 1.');
        }
