...
/**
 * AccountGroupCreateResponseAccountGroup.
 *
 * PHP version 7.3
 *
 * @category Class
...
/**
 * AccountGroupCreateResponseAccountGroup Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class AccountGroupCreateResponseAccountGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'accountGroupCreateResponse_account_group';
     ...
     *
     * @param int $account_category_id 勘定科目カテゴリID
     *
     * @return self
     */
