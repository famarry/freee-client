...
class InvoiceRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'include_amount_brought_forward'  => 'bool',
        'amount_brought_forward'          => 'int',
        'invoice_note'                    => 'string',
        'memo'                            => 'string',
        'partner_id'                      => 'int',
        'partner_code'                    => 'string',
        ...
        'lines'                           => '\OpenAPI\Client\Model\InvoiceRequestLines[]',
    ];
    ...
    protected static $openAPIFormats = [
        ...
        'include_amount_brought_forward'  => null,
        'amount_brought_forward'          => 'int64',
        'invoice_note'                    => null,
        'memo'                            => null,
        'partner_id'                      => 'int64',
        'partner_code'                    => null,
    ...
    protected static $setters = [
        ...
        'include_amount_brought_forward'  => 'setIncludeAmountBroughtForward',
    ...
    protected static $getters = [
        ...
        'include_amount_brought_forward'  => 'getIncludeAmountBroughtForward',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['payment_type']                    = $data['payment_type'] ?? 'transfer';
        ...
        $this->container['include_amount_brought_forward']  = $data['include_amount_brought_forward'] ?? false;
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['amount_brought_forward']) && ($this->container['amount_brought_forward'] > 999999999999)) {
        ...
        if (!is_null($this->container['invoice_note']) && (mb_strlen($this->container['invoice_note']) > 4000)) {
            $invalidProperties[] = "invalid value for 'invoice_note', the character length must be smaller than or equal to 4000.";
        }

        if (!is_null($this->container['invoice_note']) && (mb_strlen($this->container['invoice_note']) < 1)) {
            $invalidProperties[] = "invalid value for 'invoice_note', the character length must be bigger than or equal to 1.";
        }
        ...
        if (!is_null($this->container['bank_account_to_transfer']) && (mb_strlen($this->container['bank_account_to_transfer']) > 255)) {
            $invalidProperties[] = "invalid value for 'bank_account_to_transfer', the character length must be smaller than or equal to 255.";
        }
    ...
    public function setCompanyId($company_id)
    {
        ...
        if (($company_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling InvoiceRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (($company_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $company_id when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setTemplateId($template_id)
    {
        ...
        if (!is_null($template_id) && ($template_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling InvoiceRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($template_id) && ($template_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $template_id when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets invoice_number.
     *
     * @param string|null $invoice_number 請求書番号<br> - 採番の設定が、[自動採番する]の場合、指定できません。 - 採番の設定が、[自動採番する]以外の場合、必須になります。
     *
     * @return self
     */
    public function setInvoiceNumber($invoice_number)
    {
        if (!is_null($invoice_number) && (mb_strlen($invoice_number) > 255)) {
            throw new \InvalidArgumentException('invalid length for $invoice_number when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setBranchNo($branch_no)
    {
        ...
        if (!is_null($branch_no) && ($branch_no > 2147483647)) {
            throw new \InvalidArgumentException('invalid value for $branch_no when calling InvoiceRequest., must be smaller than or equal to 2147483647.');
        }
        if (!is_null($branch_no) && ($branch_no < 0)) {
            throw new \InvalidArgumentException('invalid value for $branch_no when calling InvoiceRequest., must be bigger than or equal to 0.');
        }
    ...
    public function setBillingDate($billing_date)
    {
        ...
        if ((!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $billing_date))) {
            throw new \InvalidArgumentException("invalid value for $billing_date when calling InvoiceRequest., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
     ...
     * Sets issue_date.
     *
     * @param \DateTime|null $issue_date 発生日（取引登録の下書き保存で利用されます。） - 入力がない場合、請求日が補完されます。
     *
     * @return self
     */
    public function setIssueDate($issue_date)
    {
        ...
        if (!is_null($issue_date) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $issue_date))) {
            throw new \InvalidArgumentException("invalid value for $issue_date when calling InvoiceRequest., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setPaymentDate($payment_date)
    {
        ...
        if (!is_null($payment_date) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $payment_date))) {
            throw new \InvalidArgumentException("invalid value for $payment_date when calling InvoiceRequest., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setSubject($subject)
    {
        if (!is_null($subject) && (mb_strlen($subject) > 255)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($subject) && (mb_strlen($subject) < 1)) {
            throw new \InvalidArgumentException('invalid length for $subject when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    /**
     * Gets include_amount_brought_forward.
     *
     * @return bool|null
     */
    public function getIncludeAmountBroughtForward()
    {
        return $this->container['include_amount_brought_forward'];
    }

    /**
     * Sets include_amount_brought_forward.
     *
     * @param bool|null $include_amount_brought_forward 繰越金額を含めるかどうか（true: 含める、false: 含めない）<br> - 含める場合は、amount_brought_forwardに繰越金額を指定することができます。 - 含める場合でamount_brought_forwardの指定がない場合は、 帳票に指定されたpartner_id, partner_codeに紐づく未決済残高が繰越金額として利用されます。
     *
     * @return self
     */
    public function setIncludeAmountBroughtForward($include_amount_brought_forward)
    {
        $this->container['include_amount_brought_forward'] = $include_amount_brought_forward;
     ...
     *
     * @param int|null $amount_brought_forward 繰越金額<br> include_amount_brought_forward に true を指定する場合のみ、指定できます。
     *
     * @return self
     */
    public function setAmountBroughtForward($amount_brought_forward)
    {
        ...
        if (!is_null($amount_brought_forward) && ($amount_brought_forward > 999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount_brought_forward when calling InvoiceRequest., must be smaller than or equal to 999999999999.');
        }
        if (!is_null($amount_brought_forward) && ($amount_brought_forward < -999999999999)) {
            throw new \InvalidArgumentException('invalid value for $amount_brought_forward when calling InvoiceRequest., must be bigger than or equal to -999999999999.');
        }
     ...
     * Sets invoice_note.
     *
     * @param string|null $invoice_note 備考
     *
     * @return self
     */
    public function setInvoiceNote($invoice_note)
    {
        if (!is_null($invoice_note) && (mb_strlen($invoice_note) > 4000)) {
            throw new \InvalidArgumentException('invalid length for $invoice_note when calling InvoiceRequest., must be smaller than or equal to 4000.');
        }
        if (!is_null($invoice_note) && (mb_strlen($invoice_note) < 1)) {
            throw new \InvalidArgumentException('invalid length for $invoice_note when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setMemo($memo)
    {
        if (!is_null($memo) && (mb_strlen($memo) > 2000)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling InvoiceRequest., must be smaller than or equal to 2000.');
        }
        if (!is_null($memo) && (mb_strlen($memo) < 1)) {
            throw new \InvalidArgumentException('invalid length for $memo when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerId($partner_id)
    {
        ...
        if (!is_null($partner_id) && ($partner_id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling InvoiceRequest., must be smaller than or equal to 9223372036854775807.');
        }
        if (!is_null($partner_id) && ($partner_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $partner_id when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerAddressZipcode($partner_address_zipcode)
    {
        if (!is_null($partner_address_zipcode) && (mb_strlen($partner_address_zipcode) > 10)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_zipcode when calling InvoiceRequest., must be smaller than or equal to 10.');
        }
        if (!is_null($partner_address_zipcode) && (mb_strlen($partner_address_zipcode) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_zipcode when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
        if (!is_null($partner_address_zipcode) && (!preg_match('/^[0-9]{3}[\\-]?[0-9]{4}$/', $partner_address_zipcode))) {
            throw new \InvalidArgumentException("invalid value for $partner_address_zipcode when calling InvoiceRequest., must conform to the pattern /^[0-9]{3}[\\-]?[0-9]{4}$/.");
        }
    ...
    public function setPartnerAddressPrefectureCode($partner_address_prefecture_code)
    {
        ...
        if (!is_null($partner_address_prefecture_code) && ($partner_address_prefecture_code > 46)) {
            throw new \InvalidArgumentException('invalid value for $partner_address_prefecture_code when calling InvoiceRequest., must be smaller than or equal to 46.');
        }
        if (!is_null($partner_address_prefecture_code) && ($partner_address_prefecture_code < -1)) {
            throw new \InvalidArgumentException('invalid value for $partner_address_prefecture_code when calling InvoiceRequest., must be bigger than or equal to -1.');
        }
    ...
    public function setPartnerAddressStreetName1($partner_address_street_name1)
    {
        if (!is_null($partner_address_street_name1) && (mb_strlen($partner_address_street_name1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name1 when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_address_street_name1) && (mb_strlen($partner_address_street_name1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name1 when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerAddressStreetName2($partner_address_street_name2)
    {
        if (!is_null($partner_address_street_name2) && (mb_strlen($partner_address_street_name2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name2 when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_address_street_name2) && (mb_strlen($partner_address_street_name2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_address_street_name2 when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerContactDepartment($partner_contact_department)
    {
        if (!is_null($partner_contact_department) && (mb_strlen($partner_contact_department) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_department when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_contact_department) && (mb_strlen($partner_contact_department) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_department when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerContactEmailCc($partner_contact_email_cc)
    {
        if (!is_null($partner_contact_email_cc) && (mb_strlen($partner_contact_email_cc) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_cc when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_contact_email_cc) && (mb_strlen($partner_contact_email_cc) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_cc when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerContactEmailTo($partner_contact_email_to)
    {
        if (!is_null($partner_contact_email_to) && (mb_strlen($partner_contact_email_to) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_to when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_contact_email_to) && (mb_strlen($partner_contact_email_to) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_email_to when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerContactName($partner_contact_name)
    {
        if (!is_null($partner_contact_name) && (mb_strlen($partner_contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_name when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($partner_contact_name) && (mb_strlen($partner_contact_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $partner_contact_name when calling InvoiceRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPartnerDisplayName($partner_display_name)
    {
        if (!is_null($partner_display_name) && (mb_strlen($partner_display_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_display_name when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string|null $partner_bank_account 取引先口座 - payment_typeがdirect_debitの場合に指定可能です。 - 入力がない場合またはpayment_typeがtransferの場合、帳票に指定されたpartner_id, partner_codeに紐づく取引先口座が利用されます。
     *
     * @return self
     */
    public function setPartnerBankAccount($partner_bank_account)
    {
        if (!is_null($partner_bank_account) && (mb_strlen($partner_bank_account) > 255)) {
            throw new \InvalidArgumentException('invalid length for $partner_bank_account when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyContactName($company_contact_name)
    {
        if (!is_null($company_contact_name) && (mb_strlen($company_contact_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_contact_name when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyName($company_name)
    {
        if (!is_null($company_name) && (mb_strlen($company_name) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setCompanyDescription($company_description)
    {
        if (!is_null($company_description) && (mb_strlen($company_description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $company_description when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
     ...
     *
     * @param string|null $bank_account_to_transfer 振込先を上書きする場合に指定します。
     *
     * @return self
     */
    public function setBankAccountToTransfer($bank_account_to_transfer)
    {
        if (!is_null($bank_account_to_transfer) && (mb_strlen($bank_account_to_transfer) > 255)) {
            throw new \InvalidArgumentException('invalid length for $bank_account_to_transfer when calling InvoiceRequest., must be smaller than or equal to 255.');
        }
     ...
     * Gets lines.
     *
     * @return \OpenAPI\Client\Model\InvoiceRequestLines[]
     */
     ...
     * Sets lines.
     *
     * @param \OpenAPI\Client\Model\InvoiceRequestLines[] $lines 請求書の明細行
     *
     * @return self
     */
