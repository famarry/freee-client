...
/**
 * InvoiceShowResponseInvoiceLines Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class InvoiceShowResponseInvoiceLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'InvoiceShowResponse_invoice_lines';
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InvoiceShowResponseInvoiceLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling InvoiceShowResponseInvoiceLines., must be bigger than or equal to 1.');
        }
     ...
     * Sets type.
     *
     * @param string $type 明細の種類 - item: 品目行 - text: テキスト行   - textの時はsales_date、quantity、unit_price、tax_rate、amount_excluding_taxはnullになります。
     *
     * @return self
     */
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling InvoiceShowResponseInvoiceLines., must be smaller than or equal to 255.');
        }
    ...
    public function setSalesDate($sales_date)
    {
        ...
        if (!is_null($sales_date) && (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $sales_date))) {
            throw new \InvalidArgumentException("invalid value for $sales_date when calling InvoiceShowResponseInvoiceLines., must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.");
        }
    ...
    public function setUnit($unit)
    {
        if (!is_null($unit) && (mb_strlen($unit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling InvoiceShowResponseInvoiceLines., must be smaller than or equal to 255.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity > 99999999.999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling InvoiceShowResponseInvoiceLines., must be smaller than or equal to 99999999.999.');
        }
        if (!is_null($quantity) && ($quantity < -99999999.999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling InvoiceShowResponseInvoiceLines., must be bigger than or equal to -99999999.999.');
        }
