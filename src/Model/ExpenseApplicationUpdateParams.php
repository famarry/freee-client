...
class ExpenseApplicationUpdateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'section_id'             => 'int',
        'tag_ids'                => 'int[]',
        'purchase_lines'         => '\OpenAPI\Client\Model\ExpenseApplicationUpdateParamsPurchaseLines[]',
     ...
     * Gets purchase_lines.
     *
     * @return \OpenAPI\Client\Model\ExpenseApplicationUpdateParamsPurchaseLines[]|null
     */
     ...
     * Sets purchase_lines.
     *
     * @param \OpenAPI\Client\Model\ExpenseApplicationUpdateParamsPurchaseLines[]|null $purchase_lines 経費申請の申請行一覧（配列）
     *
     * @return self
     */
    ...
    public function setParentId($parent_id)
    {
        if (!is_null($parent_id) && ($parent_id < 1)) {
            throw new \InvalidArgumentException('invalid value for $parent_id when calling ExpenseApplicationUpdateParams., must be bigger than or equal to 1.');
        }
