...
class ExpenseApplicationUpdateParamsPurchaseLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     *
     * @param string $transaction_date 発生日(yyyy-mm-dd)
     *
     * @return self
     */
     ...
     *
     * @param int[]|null $sub_receipt_ids 補足資料（配列）   receipt_id（証憑ファイル）を指定してください。   receipt_id（証憑ファイル）は5個まで指定できます
     *
     * @return self
     */
     ...
     *
     * @return \OpenAPI\Client\Model\ExpenseApplicationUpdateParamsExpenseApplicationLines[]|null
     */
     ...
     *
     * @param \OpenAPI\Client\Model\ExpenseApplicationUpdateParamsExpenseApplicationLines[]|null $expense_application_lines 明細行一覧（配列）
     *
     * @return self
     */
