...
/**
 * AccountGroupCreateParams Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class AccountGroupCreateParams implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'accountGroupCreateParams';
     ...
     * Sets name.
     *
     * @param string $name 決算書表示名 (20文字以内)
     *
     * @return self
     */
    public function setName($name)
    {
        if ((mb_strlen($name) > 20)) {
            throw new \InvalidArgumentException('invalid length for $name when calling AccountGroupCreateParams., must be smaller than or equal to 20.');
        }
