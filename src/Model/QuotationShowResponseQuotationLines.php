...
/**
 * QuotationShowResponseQuotationLines Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
 ...
 */
class QuotationShowResponseQuotationLines implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'QuotationShowResponse_quotation_lines';
    ...
    public function setId($id)
    {
        ...
        if (($id > 9223372036854775807)) {
            throw new \InvalidArgumentException('invalid value for $id when calling QuotationShowResponseQuotationLines., must be smaller than or equal to 9223372036854775807.');
        }
        if (($id < 1)) {
            throw new \InvalidArgumentException('invalid value for $id when calling QuotationShowResponseQuotationLines., must be bigger than or equal to 1.');
        }
    ...
    public function setDescription($description)
    {
        if ((mb_strlen($description) > 255)) {
            throw new \InvalidArgumentException('invalid length for $description when calling QuotationShowResponseQuotationLines., must be smaller than or equal to 255.');
        }
    ...
    public function setUnit($unit)
    {
        if (!is_null($unit) && (mb_strlen($unit) > 255)) {
            throw new \InvalidArgumentException('invalid length for $unit when calling QuotationShowResponseQuotationLines., must be smaller than or equal to 255.');
        }
    ...
    public function setQuantity($quantity)
    {
        ...
        if (!is_null($quantity) && ($quantity > 99999999.999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling QuotationShowResponseQuotationLines., must be smaller than or equal to 99999999.999.');
        }
        if (!is_null($quantity) && ($quantity < -99999999.999)) {
            throw new \InvalidArgumentException('invalid value for $quantity when calling QuotationShowResponseQuotationLines., must be bigger than or equal to -99999999.999.');
        }
