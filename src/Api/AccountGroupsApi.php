...
class AccountGroupsApi
{
    ...
    {
        $request = $this->createAccountGroupRequest($account_group_create_params);
        ...
        try {
            ...
            switch ($statusCode) {
                case 201:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\AccountGroupCreateResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\AccountGroupCreateResponse';
            ...
            switch ($e->getCode()) {
                case 201:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\AccountGroupCreateResponse',
    ...
    {
        return $this->createAccountGroupAsyncWithHttpInfo($account_group_create_params)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    {
        // verify the required parameter 'account_group_create_params' is set
        if ($account_group_create_params === null || (is_array($account_group_create_params) && count($account_group_create_params) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $account_group_create_params when calling createAccountGroup'
            );
        }

        $resourcePath = '/api/1/account_groups';
        $formParams   = [];
        $queryParams  = [];
        $headerParams = [];
        $httpBody     = '';
        ...
        // for model (json/xml)
        if (isset($account_group_create_params)) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($account_group_create_params));
            } else {
                $httpBody = $account_group_create_params;
            }
