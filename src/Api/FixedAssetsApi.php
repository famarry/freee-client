...
/**
 * FixedAssetsApi Class Doc Comment.
 *
 * @category Class
 *
 * @author   OpenAPI Generator team
...
class FixedAssetsApi
{
    ...
    /**
     * Operation getFixedAssets.
     *
     * 固定資産一覧の取得
     *
     * @param int    $company_id  事業所ID (required)
     * @param string $target_date 表示したい会計期間の開始年月日。開始年月日以外を指定した場合は、その日付が含まれる会計期間が対象となります。 (required)
    ...
    /**
     * Operation getFixedAssetsWithHttpInfo.
     *
     * 固定資産一覧の取得
     *
     * @param int    $company_id  事業所ID (required)
    ...
    {
        $request = $this->getFixedAssetsRequest($company_id, $target_date, $offset, $limit);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\OpenAPI\Client\Model\FixedAssetResponse', []),
            ...
            $returnType = '\OpenAPI\Client\Model\FixedAssetResponse';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\OpenAPI\Client\Model\FixedAssetResponse',
    ...
    {
        return $this->getFixedAssetsAsyncWithHttpInfo($company_id, $target_date, $offset, $limit)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getFixedAssetsAsyncWithHttpInfo.
     *
     * 固定資産一覧の取得
     *
     * @param int    $company_id  事業所ID (required)
    ...
    /**
     * Create request for operation 'getFixedAssets'.
     *
     * @param int    $company_id  事業所ID (required)
     * @param string $target_date 表示したい会計期間の開始年月日。開始年月日以外を指定した場合は、その日付が含まれる会計期間が対象となります。 (required)
     * @param int    $offset      取得レコードのオフセット (デフォルト: 0) (optional)
    ...
    public function getFixedAssetsRequest($company_id, $target_date, $offset = null, $limit = null)
    {
        ...
        if ($company_id === null || (is_array($company_id) && count($company_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $company_id when calling getFixedAssets'
            );
        }
        if ($company_id < 1) {
            throw new \InvalidArgumentException('invalid value for "$company_id" when calling FixedAssetsApi.getFixedAssets, must be bigger than or equal to 1.');
        }

        // verify the required parameter 'target_date' is set
        if ($target_date === null || (is_array($target_date) && count($target_date) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $target_date when calling getFixedAssets'
            );
        }
        if (!preg_match('/^[0-9]{4}-[0-9]{2}-[0-9]{2}$/', $target_date)) {
            throw new \InvalidArgumentException('invalid value for "target_date" when calling FixedAssetsApi.getFixedAssets, must conform to the pattern /^[0-9]{4}-[0-9]{2}-[0-9]{2}$/.');
        }

        if ($offset !== null && $offset > 2147483647) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling FixedAssetsApi.getFixedAssets, must be smaller than or equal to 2147483647.');
        }
        if ($offset !== null && $offset < 0) {
            throw new \InvalidArgumentException('invalid value for "$offset" when calling FixedAssetsApi.getFixedAssets, must be bigger than or equal to 0.');
        }

        if ($limit !== null && $limit > 200) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FixedAssetsApi.getFixedAssets, must be smaller than or equal to 200.');
        }
        if ($limit !== null && $limit < 1) {
            throw new \InvalidArgumentException('invalid value for "$limit" when calling FixedAssetsApi.getFixedAssets, must be bigger than or equal to 1.');
        }


        $resourcePath = '/api/1/fixed_assets';
        $formParams   = [];
        $queryParams  = [];
        $headerParams = [];
        $httpBody     = '';
        ...
        // query params
        if ($target_date !== null) {
            if ('form' === 'form' && is_array($target_date)) {
                foreach ($target_date as $key => $value) {
                    $queryParams[$key] = $value;
                }
            } else {
                $queryParams['target_date'] = $target_date;
            }
        }
        // query params
        if ($offset !== null) {
